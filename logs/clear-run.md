...
## Run
- generated: `2026-08-16T17:42:40+01:00`
- started: `2026-08-16T17:42:40+01:00` · finished: `2026-08-16T17:42:40+01:00` · duration: 0.0s
- final command: `uv run --with-requirements agent/requirements.txt python -m agent.run`
- final commit: `df0667a43b` (branch `feat/wire-methodology-2`)
...
- environment: Python 3.11.15 on Windows · no network calls · OPENAI_API_KEY present (not required — series replay from committed cache)
...
_processed at 2026-08-16T17:42:40+01:00_
...
- **Net sales** — nested ensemble promoted (strict config) — outer skill +0.25 on 8 unseen origins. Basis: nested causal ensemble (strict config); outer skill 24.9% across 8 unseen origins; direct cross-check 46886.0
...
- **Comparable sales, total company** — nested ensemble promoted (strict config) — outer skill +0.38 on 8 unseen origins. Basis: nested causal ensemble (strict config); outer skill 37.9% across 8 unseen origins; direct cross-check 0.84
...
- **Revenue** — nested ensemble promoted (responsive config) — outer skill +0.62 on 8 unseen origins. Basis: nested causal ensemble (responsive config); outer skill 62.1% across 8 unseen origins; direct cross-check 3900.0
- **Adjusted diluted EPS** — nested ensemble promoted (responsive config) — outer skill +0.56 on 8 unseen origins. Basis: nested causal ensemble (responsive config); outer skill 55.6% across 8 unseen origins; direct cross-check 3.3
- **Adjusted gross margin** — nested ensemble promoted (responsive config) — outer skill +0.54 on 8 unseen origins. Basis: nested causal ensemble (responsive config); outer skill 53.9% across 8 unseen origins; direct cross-check 74.0
...
- **Net fees** — guarded fallback → direct: outer skill is not positive; deployment forecast fell back to seasonal naive. Basis: FY2025 net fees £972m × (1+-5% reported YoY)
- **Pre-exceptional basic EPS** — guarded fallback → direct: outer skill is not positive; deployment forecast fell back to seasonal naive. Basis: bridge: operating profit × approx after-tax/share ratio (pence) — coarse, refine with shares/tax
- **Pre-exceptional operating profit** — guarded fallback → direct: outer skill is not positive; deployment forecast fell back to seasonal naive. Basis: stated top of £37–46m; consensus £Nonem → ~£45.5m
...
- **Worldwide net sales and revenues** — nested ensemble promoted (strict config) — outer skill +0.27 on 8 unseen origins. Basis: nested causal ensemble (strict config); outer skill 27.3% across 8 unseen origins; direct cross-check 11657.0
- **Diluted EPS (GAAP)** — nested ensemble promoted (strict config) — outer skill +0.06 on 8 unseen origins. Basis: nested causal ensemble (strict config); outer skill 5.8% across 8 unseen origins; direct cross-check 4.88
- **Production & Precision Ag operating profit** — nested ensemble promoted (strict config) — outer skill +0.07 on 8 unseen origins. Basis: nested causal ensemble (strict config); outer skill 6.9% across 8 unseen origins; direct cross-check 1154.0
...
- `2026-08-16T17:42:40+01:00` — loaded manifest — 4 companies, 12 target numbers
- `2026-08-16T17:42:40+01:00` — HD: 3/3 numbers (2 nested, 1 direct) → wrote HD-FY2026Q2.xlsx
- `2026-08-16T17:42:40+01:00` — ADI: 3/3 numbers (3 nested, 0 direct, 2 guidance-guarded) → wrote ADI-FY2026Q3.xlsx
- `2026-08-16T17:42:40+01:00` — HAS: 3/3 numbers (0 nested, 3 direct) → wrote HAS-FY2026.xlsx
- `2026-08-16T17:42:40+01:00` — DE: 3/3 numbers (3 nested, 0 direct) → wrote DE-FY2026Q3.xlsx
- `2026-08-16T17:42:40+01:00` — wrote nested-parameter-evaluation report
